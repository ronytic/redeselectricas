...
$folder="../../";
$titulo="Registro de Salida de Material";
    ...
    $("[name=codmaterial]").change(function(){
       ...
       var codalmacen=$("[name=codalmacen]").val();
        $.post("datos.php",{'codmaterial':codmaterial,"codalmacen":codalmacen},function(data){
           ...
           $("[name=cantidad]").attr("max",data.stock)
      ...
      <tr>
       ...
       <tr>
        ...
        <tr>
            ...
            <td><input type="number" name="stock" class="form-control" min="0" step="1" value="0" readonly>
            <input type="hidden" name="precioventa" class="form-control" min="0" step="1" value="0" readonly>
            </td>
        </tr>
        <tr>
            <td class="text-right">Cantidad a Salida</td>
        ...
        <tr>
            ...
            <td><select name="tipo" class="form-control">
                    ...
                    <option value="traspaso">Trapaso</option>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><div class="alert alert-danger"><b>Por Seguridad del Inventario no se permite Modificar la Salida del Material, VERIFIQUE NUEVAMENTE</b></div></td>
        </tr>

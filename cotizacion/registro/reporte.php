...
foreach($cotd as $cd){
    ...
    $pdf->CuadroCuerpo(25,$mat['codigo'],0,"L",1);
    $pdf->CuadroCuerpo(30,$mat['nombre'],0,"L",1);
    $pdf->CuadroCuerpo(25,$mat['marca'],0,"L",1);
    $pdf->CuadroCuerpo(25,$mat['procedencia'],0,"L",1);
    $pdf->CuadroCuerpo(10,$cd['cantidad'],0,0,1);
    $pdf->CuadroCuerpo(15,$cd['unidad'],0,0,1);
    $pdf->CuadroCuerpo(20,number_format($cd['precio'],2),0,0,1);
    $pdf->CuadroCuerpo(20,number_format($cd['total'],2,".",""),0,0,1);
    $pdf->ln();
}
$pdf->CuadroCuerpo(123,"Son:".num2letras(number_format($cot['subtotal'],2,".","")),0,"L",1,9,"B");
$pdf->CuadroCuerpo(35,"Subtotal:",0,"R",1,9,"B");
$pdf->CuadroCuerpo(20,number_format($cot['subtotal'],2,".",""),0,"R",1,9,"B");
$pdf->ln();
$pdf->CuadroCuerpo(123,"",0,"L",0,9,"B");

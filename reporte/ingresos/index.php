...
$folder="../../";
$titulo="Reporte  de Ingreso de Materiales";
          ...
          <td>Almacén <br><select name="codalmacen" class="form-control" autofocus>
           ...
           <td>Proveedor <br><select name="codproveedor" class="form-control" autofocus>
            ...
            <td>Material<br>
             ...
             <td>Desde Fecha de Ingreso<br>
                 <input type="date" name="fechaIngresoDesde" class="form-control">
             </td>
             <td>Hasta Fecha de Ingreso<br>
                 <input type="date" name="fechaIngresoHasta" class="form-control">
             </td>

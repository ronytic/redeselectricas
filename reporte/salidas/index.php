...
$folder="../../";
$titulo="Reporte  de Salida de Materiales";
          ...
          <td>Almacén <br><select name="codalmacen" class="form-control" autofocus>
           ...
           <td>Proveedor <br><select name="codproveedor" class="form-control" autofocus>
            ...
            <td>Material<br>
             ...
             <td>Desde Fecha de Salida<br>
                 <input type="date" name="fechaSalidaDesde" class="form-control">
             </td>
             <td>Hasta Fecha de Salida<br>
                 <input type="date" name="fechaSalidaHasta" class="form-control">
             </td>
